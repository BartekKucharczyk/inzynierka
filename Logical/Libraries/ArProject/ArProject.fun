...
{REDUND_OK} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArProjectGetInfo	(*Reads the ConfigurationID and ConfigurationVersion of the current project on the target*)
	VAR_INPUT
...
{REDUND_OK} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArProjectGetPackageInfo	(*Reads the ConfigurationID and ConfigurationVersion from a project-installation-package*)
	VAR_INPUT
		Execute			: BOOL;					(*Start execution.*)
...
{REDUND_OK} {REDUND_UNREPLICABLE} FUNCTION_BLOCK ArProjectInstallPackage	(*Installs the referenced project-installation-package*)
	VAR_INPUT
		Execute			: BOOL;					(*Start execution.*)
		DeviceName		: STRING[128];			(*Device (configured in AS or created with FileIO devLin) where the project-installation-package is located.*)
		FilePath		: STRING[256];			(*Path to the til.xml file of the project-installation-package (relative to the provided device).*)
